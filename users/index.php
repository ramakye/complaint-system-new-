...
<html lang="en">
  <head>
    ...
    <title>Progress System | User Login</title>
...
return true;
  ...
  <body>
      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="login-page">
	  	<div class="container">
	  		<h3 align="center" style="color:#fff"><a href="../index.html" style="color:#fff">Progress System</a></h3>
	<hr />
    ...
    <script>
        $.backstretch("assets/img/bk.jpg", {speed: 500});
    </script>
