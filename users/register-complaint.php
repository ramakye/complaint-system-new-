...
$complainno=$cmpn;
echo '<script> alert("Your Issue has been successfully filled and your complaintno is  "+"' .$complainno.'")</script>';
}
?>
...
<html lang="en">
  <head>
    ...
    <title>CMS | User Register Issue</title>
...
<select name="complaintype" class="form-control" required="">
                <option value=" Complaint"> General Issue</option>
                <option value=" Complaint"> Specific Issue</option>
                </select> 
</div>
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label"> Detailed Information (max 2000 words) </label>
<div class="col-sm-6">
